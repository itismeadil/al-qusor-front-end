// Minimal, hand-rolled i18n — no library needed for this small a set of
// strings. Add keys here as new UI text is introduced.
const translations = {
  en: {
    appName: 'Al Qusor',
    ...
    homeTagline: "Scan a product's QR code in-store to see its photos and details.",
    signIn: 'Sign in',
    ...
    noSignupNote: "Accounts are created by the shop owner directly — there's no self sign-up.",
    products: 'Products',
    productsSubtitle: "Every scanned QR code points to one of these product pages.",
    ...
    noProductsBody: 'Use "Add Product" above to add your first item — a QR code is generated automatically once it\u2019s saved.',
  ...
  ar: {
    ...
    homeTagline: 'امسح رمز الاستجابة السريعة للمنتج داخل المتجر لعرض الصور والتفاصيل.',
    signIn: 'تسجيل الدخول',
    ...
    noSignupNote: 'يتم إنشاء الحسابات من قبل صاحب المتجر مباشرة — لا يوجد تسجيل ذاتي.',
    products: 'المنتجات',
    ...
    noProductsBody: 'استخدم زر "إضافة منتج" أعلاه لإضافة أول منتج — سيتم إنشاء رمز الاستجابة السريعة تلقائياً بعد الحفظ.',
